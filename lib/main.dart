import 'package:adab_orang_tua/Tampil_adab.dart';
...
class HomeUtama extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(
          children: <Widget>[
            Text('Adab kepada Orang Tua',style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold)),
            ListView(
              children: <Widget>[
                _itemMenuUtama(context, "Adab - adab orang tua", Tampil_adab())
              ],
            )
          ],
        )
